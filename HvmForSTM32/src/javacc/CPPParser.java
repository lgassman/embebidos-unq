...
sym.CloseScope();
  ...
  static final public void external_declaration() throws ParseException {boolean isTypedef = false;
  ...
  static final public void function_definition() throws ParseException {Scope sc = null;
   boolean isTypedef;
    if (jj_2_12(3)) {
      isTypedef = declaration_specifiers();
  ...
  static final public void func_decl_def(Scope sc) throws ParseException {boolean closeReqd = false;
...
if (closeReqd) sym.CloseScope();
  ...
  static final public void declaration() throws ParseException {boolean isTypedef = false;
    if (jj_2_16(2)) {
      isTypedef = declaration_specifiers();
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case LPARENTHESIS:
 ...
 */
  static final public boolean type_modifiers() throws ParseException {boolean isTypedef = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case AUTO:
    case EXTERN:
    case REGISTER:
 ...
 * need a structure that stores all the attributes.
 */
  static final public boolean declaration_specifiers() throws ParseException {Token t;
...
*/
  static final public 
void simple_type_specifier() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CHAR:
    case DOUBLE:
    case FLOAT:
  ...
  static final public String scope_override() throws ParseException {String name = "";
   Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SCOPE:{
      jj_consume_token(SCOPE);
...
{if ("" != null) return name;}
  ...
  static final public String qualified_id() throws ParseException {String name = "";
   Token t;
...
{if ("" != null) return true;}
  ...
  static final public void init_declarator(boolean isTypedef) throws ParseException {String name;
    name = declarator();
if (isTypedef)
  ...
  static final public void class_specifier() throws ParseException {ClassScope sc = null;
   Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case STRUCT:{
      jj_consume_token(STRUCT);
...
sym.PutTypeName(t.image);
  ...
  static final public void base_specifier(ClassScope scope) throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PRIVATE:
    case PROTECTED:
    case PUBLIC:
...
scope.AddSuper(sym.GetScope(t.image));
  ...
  static final public void member_declaration() throws ParseException {boolean isTypedef = false;
  ...
  static final public void member_declarator(boolean isTypedef) throws ParseException {String name;
    name = declarator();
if (isTypedef)
         sym.PutTypeName(name);
  }

  static final public void conversion_function_decl_or_def() throws ParseException {Scope sc = null;
   String name = null;
  ...
  static final public void enum_specifier() throws ParseException {Token t;
...
sym.PutTypeName(t.image);
  ...
  static final public String declarator() throws ParseException {String name;
...
{if ("" != null) return name;}
  ...
  static final public String direct_declarator() throws ParseException {String name;
   Token t;
    if (jj_2_63(2)) {
 ...
 */
  ...
  static final public Scope function_declarator(boolean isTypedef) throws ParseException {Scope sc = null;
...
{if ("" != null) return sc;}
  ...
  static final public Scope function_direct_declarator(boolean isTypedef) throws ParseException {String name;
  Scope sc = null;
...
if (closeReqd)
  ...
  static final public void ctor_definition() throws ParseException {Scope sc = null;
   boolean closeReqd = false;
    dtor_ctor_decl_spec();
    sc = ctor_declarator();
if (closeReqd = (sc != null && sc != sym.GetCurScope()))
...
if (closeReqd) sym.CloseScope();
  ...
  static final public Scope ctor_declarator() throws ParseException {String name;
  Scope sc = null;
  boolean closeReqd = false;
    if (IsCtor()) {
...
if (closeReqd)
  ...
  static final public void template_parameter() throws ParseException {Token t;
    if (jj_2_87(3)) {
      jj_consume_token(CLASS);
      t = jj_consume_token(ID);
sym.PutTypeName(t.image);
